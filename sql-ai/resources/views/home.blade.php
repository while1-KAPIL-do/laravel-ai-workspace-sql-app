...
<body>
    ...
    <section id="hero">
        ...
        <div class="hero-strip">
            <div class="strip-item"><div class="sk mono">experience</div><div class="sv">5+ yrs</div></div>
            <div class="strip-item"><div class="sk mono">users_served</div><div class="sv">1M+</div></div>
            <div class="strip-item"><div class="sk mono">bugs_reduced</div><div class="sv">50% ↓</div></div>
            <div class="strip-item"><div class="sk mono">ai_tools</div><div class="sv">4 live</div></div>
            <div class="strip-item"><div class="sk mono">core_stack</div><div class="sv">Kafka · LLM · AWS</div></div>
        </div>
    </section>
    ...
    <section class="sec" id="work">
        <div class="sec-hd">
            ...
            <a href="https://github.com/while1-KAPIL-do" target="_blank" rel="noopener" class="sec-link mono">github ↗</a>
        </div>
        <div class="proj-list">
            ...
            <a class="proj-item fade-up">
                ...
                <div class="proj-info">
                    ...
                    <div class="proj-desc mono">AI-powered PRD → Low-Level Design generator · FastAPI · LangChain · ChromaDB · AWS ECS</div>
                </div>
                <div class="proj-tags">
                    <!-- <span class="ptag wip">BUILDING</span> -->
                    <span class="ptag inprogress">In Progress</span>
                    <span class="ptag cat">AI / LLM</span>
            ...
            <a class="proj-item fade-up" href="/ai/token-dashboard">
                ...
                <div class="proj-info">
                    ...
                    <div class="proj-desc mono">Real-time multi-provider LLM token usage and cost tracking · live at /ai/token-dashboard</div>
                </div>
                <div class="proj-tags">
                    <span class="ptag live">LIVE ✦</span>
                    <span class="ptag cat">Dashboard</span>
                    <span class="ptag soon">2026</span>
                </div>
                <span class="proj-arr">↗</span>
            </a>
            ...
            <a class="proj-item fade-up" href="/ai/sql-assistant">
                ...
                <div class="proj-info">
                    ...
                    <div class="proj-desc mono">Voice → natural language → SQL · live at /ai/sql-assistant</div>
                </div>
                <div class="proj-tags">
                    <span class="ptag live">LIVE ✦</span>
                    <span class="ptag cat">NLP</span>
                    <span class="ptag soon">2026</span>
                </div>
                <span class="proj-arr">↗</span>
            </a>
    ...
    <section class="sec" id="about">
        ...
        <div class="about-grid">
            ...
            <div class="about-r fade-up">
                <div class="stat-grid">
                    <div class="stat-card"><div class="stat-n">5<span>+</span></div><div class="stat-l mono">years_production</div></div>
                    <div class="stat-card"><div class="stat-n">1M<span>+</span></div><div class="stat-l mono">users_served</div></div>
                    <div class="stat-card"><div class="stat-n">50<span>%</span></div><div class="stat-l mono">bugs_reduced</div></div>
                    <div class="stat-card"><div class="stat-n">40<span>%</span></div><div class="stat-l mono">faster_onboarding</div></div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="sec" id="skills">
        ...
        <div class="skills-wrap">
            <div class="sg fade-up"><div class="sg-title mono">// backend</div><div class="sg-list"><span>FastAPI</span><span>Laravel</span><span>REST APIs</span><span>Microservices</span></div></div>
            <div class="sg fade-up"><div class="sg-title mono accent">// ai · llm</div><div class="sg-list accent-list"><span>LangChain</span><span>RAG</span><span>Vector Search</span><span>ChromaDB</span><span>Embeddings</span></div></div>
            <div class="sg fade-up"><div class="sg-title mono">// streaming</div><div class="sg-list"><span>Apache Kafka</span><span>Event-Driven Arch</span></div></div>
            <div class="sg fade-up"><div class="sg-title mono accent">// cloud · devops</div><div class="sg-list accent-list"><span>AWS ECS</span><span>AWS S3</span><span>Docker</span><span>CI/CD</span></div></div>
            <div class="sg fade-up"><div class="sg-title mono">// data · tools</div><div class="sg-list"><span>MySQL</span><span>Redis</span><span>Git</span><span>Postman</span><span>JIRA</span></div></div>
        </div>
    </section>
    ...
    <footer id="contact">
        ...
        <div class="footer-bot">
            ...
            <div class="footer-links">
                ...
                <a href="mailto:kapillabs.work@gmail.com" class="mono">✉</a>
            </div>
        </div>
    </footer>
    ...
    (function(){
        ...
        /* Hamburger */
        var hb=document.getElementById('hamburger'),dr=document.getElementById('navDrawer');
        hb.addEventListener('click',function(){dr.classList.toggle('open');hb.classList.toggle('open');});
        document.querySelectorAll('.drawer-link').forEach(function(l){l.addEventListener('click',function(){dr.classList.remove('open');hb.classList.remove('open');});});

        /* Keyword cycle */
        var kws=document.querySelectorAll('.kw'),ki=0;
        setInterval(function(){kws[ki].classList.remove('active');ki=(ki+1)%kws.length;kws[ki].classList.add('active');},1800);

        /* Scroll reveal */
        var els=document.querySelectorAll('.fade-up');
        els.forEach(function(el){el.classList.add('will-anim');});
        var obs=new IntersectionObserver(function(entries){
            entries.forEach(function(e){
                if(e.isIntersecting){setTimeout(function(){e.target.classList.add('in-view');},60);obs.unobserve(e.target);}
            });
        ...
        var n1=document.querySelector('.hero-n1'),n2=document.querySelector('.hero-n2');
        if(n1&&n2){
            n1.style.opacity='0';n2.style.opacity='0';
            setTimeout(function(){
                n1.style.transition='opacity .05s';n1.style.opacity='1';
                setTimeout(function(){n1.style.opacity='0';setTimeout(function(){n1.style.transition='opacity .5s';n1.style.opacity='1';setTimeout(function(){n2.style.transition='opacity .5s .1s';n2.style.opacity='1';},180);},80);},60);
            },500);
        }
    })();
    </script>
